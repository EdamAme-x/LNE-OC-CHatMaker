export default function MsgYou(props: any) {
  return (
    <>
      <div className="msg-you">
        <div className="msg-you-icon">
          <img src={props.image} alt="icon" className="msg-you-icon" />
          <div className="msg-you-name">{props.name}</div>
        </div>

        <div className="msg-you-flex">
          <div
            dangerouslySetInnerHTML={{ __html: props.text }}
            className="msg-you-text"
          ></div>

          <div className="msg-you-time">{props.time}</div>
        </div>
      </div>
